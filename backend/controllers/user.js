const user = require('../config/middlewares/models/user');
const Post = require('../config/middlewares/models/post');
const {sendemail} = require('../config/middlewares/sendemail')
